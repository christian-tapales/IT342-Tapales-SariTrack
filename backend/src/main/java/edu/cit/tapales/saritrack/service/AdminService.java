...
public class AdminService {
    ...
    public edu.cit.tapales.saritrack.dto.PlatformStatsDTO getPlatformStats() {
        edu.cit.tapales.saritrack.dto.PlatformStatsDTO stats = new edu.cit.tapales.saritrack.dto.PlatformStatsDTO();
        ...
        List<edu.cit.tapales.saritrack.entity.Order> recentOrders = orderRepository.findAll().stream()
